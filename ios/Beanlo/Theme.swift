...
// light values first, warm low-glare night palette second. Every colour
// adapts automatically via dynamic providers.
extension Color {
    ...
    // Chart palette (validated categorical colours from the web dashboard)
