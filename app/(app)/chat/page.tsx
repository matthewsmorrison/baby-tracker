  ...
  if (ctx.baby.membership_tier !== "advanced") {
    return (
      <Card className="p-6 text-center animate-rise">
        ...
        <p className="font-semibold">Ask is part of Advanced</p>
        <p className="mx-auto mt-1 max-w-xs text-sm text-muted">
          Advanced membership adds AI photo labelling and this chat — ask
          anything about {ctx.baby.name}’s feeds, nappies and weight.
